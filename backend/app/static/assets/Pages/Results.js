...
export class ResultsPage {
    ...
    setResult(result) {
        ...
        this.summaries.innerHTML = "";
        this.summaries.appendChild(createElement("p", "summary-block", [result.summary_pt || "No summary yet."]));
        this.summaries.appendChild(createElement("p", "summary-block", [result.summary_en || "No English summary yet."]));
        this.jsonSlot.innerHTML = "";
